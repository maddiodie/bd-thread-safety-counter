...
public class RaceCounter {
    ...
    /*
    (1) Change the type of counter to an Atomic type. (2) Make adjustments to the lambda Runnable and to
    getCounter() in order to support the use of an Atomic type.
     */
